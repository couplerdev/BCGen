module time_type
    ...
    use ESMF
    implicit none
    integer,   parameter :: max_clocks = 7+1
    integer,   parameter :: max_alarms = 7+6
    integer,   parameter :: clock_drv = 1
    integer,   parameter :: clock_ocn = 2
    integer,   parameter :: clock_atm = 3
    integer,   parameter :: clock_atm = 4
    integer,   parameter :: clock_ice = 5
    integer,   parameter :: clock_rof = 6
    integer,   parameter :: clock_lnd = 7
    integer,   parameter :: clock_lnd = 8
    ...
    integer,   parameter :: alarm_ocnrun = 7
    integer,   parameter :: alarm_atmrun = 8
    integer,   parameter :: alarm_atmrun = 9
    integer,   parameter :: alarm_icerun = 10
    integer,   parameter :: alarm_rofrun = 11
    integer,   parameter :: alarm_lndrun = 12
    integer,   parameter :: alarm_lndrun = 13
