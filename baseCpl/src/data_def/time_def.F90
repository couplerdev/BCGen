module time_type
    ...
    use ESMF
    implicit none
    integer,   parameter :: max_clocks = 5+1
    integer,   parameter :: max_alarms = 5+6
    integer,   parameter :: clock_drv = 1
    integer,   parameter :: clock_lnd = 2
    integer,   parameter :: clock_atm = 3
    integer,   parameter :: clock_rof = 4
    integer,   parameter :: clock_ice = 5
    integer,   parameter :: clock_ocn = 6
    ...
    integer,   parameter :: alarm_rofrun = 9
    integer,   parameter :: alarm_icerun = 10
    integer,   parameter :: alarm_ocnrun = 11
