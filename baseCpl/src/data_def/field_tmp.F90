...
subroutine fldsMeta_add_name(fldsMetaData, shortname, longname, stdname, units, ierr)
    ...
    ! local
    character(FIELDLEN) :: unkown = "unkown"
    character(FIELDLEN) :: llongname = ''
    character(FIELDLEN) :: lstdname = ''
    character(FIELDLEN) :: lunits = ''
...
subroutine fldsMeta_lookup(fldsMetaData, shortname, longname, stdname, units)
    ...
    ! local 
    integer                 :: i
    character(len=FIELDLEN) :: unkown = "unkown"
    character(len=FIELDLEN) :: llongname = ''
    character(len=FIELDLEN) :: lstdname = ''
    character(len=FIELDLEN) :: lunits = ''
