...
#  the main CICE compile system.  It builds a series of dependency files
#  for each source file to be compiled.  It is called from the main cice
#  makefile.
#
#----------------------------------------------------------------------------
...
$(DepDir)/%$(DEPSUF): %.f90
	@echo '$(CICEARCH) Making depends for compiling' $<
	@$(AWK) -f $(CICEDIR)/build/fdepends.awk -v NAME=$(basename $<) -v SUF=$(suffix $<) -v COMPDIR=$(CICEEXEDIR)/compile $< > $(DepDir)/$(@F)
