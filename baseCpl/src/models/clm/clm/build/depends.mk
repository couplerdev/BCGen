...
#  the main CLM compile system.  It builds a series of dependency files
#  for each source file to be compiled.  It is called from the main clm
#  makefile.
#
#----------------------------------------------------------------------------
...
$(DepDir)/%$(DEPSUF): %.f90
	@echo '$(CLMARCH) Making depends for compiling' $<
	@$(AWK) -f $(CLMDIR)/build/fdepends.awk -v NAME=$(basename $<) -v SUF=$(suffix $<) -v COMPDIR=$(CLMEXEDIR)/compile $< > $(DepDir)/$(@F)
