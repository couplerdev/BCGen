...
! from /share/BCGen/develDir/BCGenV2.1/BCGen/baseCpl/src/depUtils/ParallelIO/tests/general/pio_decomp_tests_3d.F90.in
...
USE pio_tutil
  ...
  integer :: num_iotypes
   ! pio_decomp_tests_3d.F90.in:113
  ...
  allocate(exp_val(nrows, ncols, nhgts))
   ! pio_decomp_tests_3d.F90.in:145
  do k=1,nhgts
    do j=1,ncols
      do i=1,nrows
        tmp_idx = (k - 1) * (ncols * nrows) + (j - 1) * nrows + i
  ...
  do i=1,num_iotypes
    ...
    IF (.NOT. (PIO_TF_Passert_((ierr) == PIO_NOERR, pio_tf_comm_))) THEN
      ...
      IF (pio_tf_world_rank_ == 0) THEN
        PRINT *, "PIO_TF: PIO Function failed:",&
          ...
          ":", __FILE__, ":", __LINE__,&
          "(pio_decomp_tests_3d.F90.in:166)"
      END IF
      RETURN
    END IF
    ...
    IF (.NOT. (PIO_TF_Passert_((ierr) == PIO_NOERR, pio_tf_comm_))) THEN
      ...
      IF (pio_tf_world_rank_ == 0) THEN
        PRINT *, "PIO_TF: PIO Function failed:",&
          ...
          ":", __FILE__, ":", __LINE__,&
          "(pio_decomp_tests_3d.F90.in:169)"
      END IF
      RETURN
    END IF
    ...
    IF (.NOT. (PIO_TF_Passert_((ierr) == PIO_NOERR, pio_tf_comm_))) THEN
      ...
      IF (pio_tf_world_rank_ == 0) THEN
        PRINT *, "PIO_TF: PIO Function failed:",&
           "Failed to define a dim : " // trim(filename),&
          ":", __FILE__, ":", __LINE__,&
          "(pio_decomp_tests_3d.F90.in:172)"
      END IF
      RETURN
    END IF
    ...
    IF (.NOT. (PIO_TF_Passert_((ierr) == PIO_NOERR, pio_tf_comm_))) THEN
      ...
      IF (pio_tf_world_rank_ == 0) THEN
        PRINT *, "PIO_TF: PIO Function failed:",&
           "Failed to define a dim : " // trim(filename),&
          ":", __FILE__, ":", __LINE__,&
          "(pio_decomp_tests_3d.F90.in:175)"
      END IF
      RETURN
    END IF
    ...
    IF (.NOT. (PIO_TF_Passert_((ierr) == PIO_NOERR, pio_tf_comm_))) THEN
      ...
      IF (pio_tf_world_rank_ == 0) THEN
        PRINT *, "PIO_TF: PIO Function failed:",&
          ...
          ":", __FILE__, ":", __LINE__,&
          "(pio_decomp_tests_3d.F90.in:178)"
      END IF
      RETURN
    END IF
    ...
    IF (.NOT. (PIO_TF_Passert_((ierr) == PIO_NOERR, pio_tf_comm_))) THEN
      ...
      IF (pio_tf_world_rank_ == 0) THEN
        PRINT *, "PIO_TF: PIO Function failed:",&
          ...
          ":", __FILE__, ":", __LINE__,&
          "(pio_decomp_tests_3d.F90.in:181)"
      END IF
      RETURN
    END IF
    ...
    IF (.NOT. (PIO_TF_Passert_((ierr) == PIO_NOERR, pio_tf_comm_))) THEN
      ...
      IF (pio_tf_world_rank_ == 0) THEN
        PRINT *, "PIO_TF: PIO Function failed:",&
          ...
          ":", __FILE__, ":", __LINE__,&
          "(pio_decomp_tests_3d.F90.in:185)"
      END IF
      RETURN
    END IF
   ! pio_decomp_tests_3d.F90.in:186
    call PIO_syncfile(pio_file)
   ! pio_decomp_tests_3d.F90.in:188
   ...
   ! pio_decomp_tests_3d.F90.in:198
  ...
  deallocate(rbuf)
  deallocate(wbuf)
END SUBROUTINE nc_write_read_3d_col_decomp_PIO_int_integer__
