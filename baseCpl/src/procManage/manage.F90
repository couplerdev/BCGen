...
subroutine init(metaData)
    ...
    character(*), parameter :: nmlfile = "/root/workspace/BCGen-test-5/conf/nmlfile"
    character(*), parameter :: datanml = "/root/workspace/BCGen-test-5/src/nmlfile_src"
    character(*), parameter :: datarc = "/root/workspace/BCGen-test-5/src/mapper.rc"
    character(*), parameter :: pionml = "/root/workspace/BCGen-test-5/conf/pioNml"
