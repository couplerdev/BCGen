...
subroutine init(metaData)
    ...
    character(*), parameter :: nmlfile = "/root/workspace/BCGen-test-13/conf/nmlfile"
    character(*), parameter :: datanml = "/root/workspace/BCGen-test-13/src/nmlfile_src"
    character(*), parameter :: datarc = "/root/workspace/BCGen-test-13/src/mapper.rc"
    character(*), parameter :: pionml = "/root/workspace/BCGen-test-13/conf/pioNml"
