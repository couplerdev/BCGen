...
subroutine init(metaData)
    ...
    character(*), parameter :: nmlfile = "/root/workspace/BCGen_test_1/conf/nmlfile"
    character(*), parameter :: datanml = "/root/workspace/BCGen_test_1/src/nmlfile_src"
    character(*), parameter :: datarc = "/root/workspace/BCGen_test_1/src/mapper.rc"
    character(*), parameter :: pionml = "/root/workspace/BCGen_test_1/conf/pioNml"
